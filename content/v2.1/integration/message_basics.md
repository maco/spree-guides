...
***
See the [Creating Endpoints](basic_endpoints_tutorial) tutorial for more detailed examples of how to build simple endpoints.
***
...
[Parameters](terminology#parameters) serve as a mechanism for transmitting this type of information to the endpoint. They are configured on a per store basis using the mapping tool (see the [Mapping Configuration](mapping_basics)) guide for more details.
